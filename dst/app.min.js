...
>>>>>>> f22388d96ab748550610016922e9a177d19c3d3d
},{},{id:13,name:"Aethertech",icon:"img/gladiator.jpg"},{id:14,name:"Gunner",icon:"img/gunner.png"},{},{id:16,name:"Bard",icon:"img/barde.png"}],q.getCharacterRank=function(a){return q.characterSoldierRankIds[a]},q.getCharacterClass=function(a){return q.characterClassIds[a]},q.getFromServer=function(a,b){var c=n.first(function(c){return c.serverName==b&&c.date==a});return c?i.resolve(c):i.likeNormal(j({url:d+"data/Servers/"+a+"/"+b+".json",method:"GET"})).then(function(c){var d={serverName:b,date:a,data:c};return n.push(d),d})},q.getLastFromServer=function(a){return q.getFromServer(b(),a)},q.getCharacterInfo=function(a,b){var c=o.first(function(c){return c.serverName==a&&c.characterID==b});return c?i.resolve(c):j({url:d+"data/Servers/Characters/"+a+"/"+b+".json",method:"GET"}).then(function(b){return b.data.status.forEach(function(a){a.date=h(a.date)}),b.data.names.forEach(function(a){a.date=h(a.date)}),b.data.guilds.forEach(function(a){a.date=h(a.date)}),e(a,b.data).then(function(a){return o.push(a),a})})},q.getLastServerData=function(){return b()},q.characterSearch=function(a){var b=a.trim().toLowerCase();return c().then(function(a){var c=a.where(function(a){return a.characterName.toLowerCase().indexOf(b)>=0});return c.sort(function(a,c){var d=a.characterName.toLowerCase().indexOf(b),e=c.characterName.toLowerCase().indexOf(b);if(d===e){var f=a.characterName.length,g=c.characterName.length;return f==g?a.characterName.toLowerCase().localeCompare(c.characterName.toLowerCase()):f-g}return d-e}),c})}}var c=!1,d=c?"":"http://91.184.11.238/";a.module("mainApp").service("storedDataService",["$hs",b])}(angular),function(a){"use strict";function b(a){var b=a.$q,c=(a.$instantiate("$log"),a.$instantiate("$http")),e=(a.$instantiate("$window"),this);e.getChannel=function(a){return b.likeNormal(c({ignoreLoadingBar:!0,url:"https://api.twitch.tv/kraken/channels/"+a,method:"GET",headers:{"client-ID":d}}))},e.getStream=function(a){return b.likeNormal(c({ignoreLoadingBar:!0,url:"https://api.twitch.tv/kraken/streams/"+a,method:"GET",headers:{"client-ID":d}}))}}var c="twitchService",d="vauqjofyej3848u68hpah3aqjjvjcl";a.module("mainApp").service(c,["$hs",b])}(angular),function(a){"use strict";function b(a){var b=this,c=a.get("$q"),e=a.get("$timeout"),f=null,g={};b.$setParent=function(a){return f=a,b},b.$q=c,b.$q.likeHttp=function(a){if(a.promise)return a.promise.success=function(b){return a.promise.then(b),a.promise},a.promise.error=function(b){return a.promise["catch"](b),a.promise},a;if(a.then){var d=b.likeHttp(c.defer());return a.then(d.resolve),a["catch"](d["catch"]),d.promise}},b.$q.likeNormal=function(a){var b=c.defer();return a.success(b.resolve)["catch"](b.reject),b.promise},b.$q.timeTrigger=function(a,b,c){return c||(c=d),g[a]&&e.cancel(g[a]),g[a]=e(b,c),g[a]},b.$q.cancelTimeTrigger=function(a){g[a]&&e.cancel(g[a])}}var c="helperService.$q",d=1e3;a.module("mainApp").service(c,["$injector",b])}(angular);