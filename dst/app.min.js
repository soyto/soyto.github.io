...
a.module("mainApp").service("$hs",["$injector",b]);var c=/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i,d=/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i}(angular),function(a){"use strict";function b(a){function b(){return i.storedDates[i.storedDates.length-1]}var c=a.$q,e=a.$instantiate("$http"),f=a.$instantiate("$window"),g=[],h=[];f.$cacheServerData=g,f.$cacheCharacterInfo=h;var i=this;i.serversList=[{id:53,name:"Antriksha"},{id:49,name:"Barus"},{id:52,name:"Deyla"},{id:54,name:"Hellion"},{id:55,name:"Hyperion"},{id:50,name:"Loki"},{id:37,name:"Thor"},{id:40,name:"Urtem"}],i.storedDates=a.sortDates(f.storedDates),i.characterSoldierRankIds=[{id:0,name:"Unknown"},{id:1,name:"Unknown"},{id:2,name:"Unknown"},{id:3,name:"Unknown"},{id:4,name:"Unknown"},{id:5,name:"Unknown"},{id:6,name:"Unknown"},{id:6,name:"Unknown"},{id:7,name:"Unknown"},{id:9,name:"Unknown"},{id:10,name:"Army 1-Star Officer"},{id:11,name:"Army 2-Star Officer"},{id:12,name:"Army 3-Star Officer"},{id:13,name:"Army 4-Star Officer"},{id:14,name:"Army 5-Star Officer"},{id:15,name:"General"},{id:16,name:"Great general"},{id:17,name:"Commander"},{id:18,name:"Governor"}],i.characterClassIds=[{},{id:1,name:"Gladiator",icon:"img/gladiator.jpg"},{id:2,name:"Templar",icon:"img/templar.jpg"},{},{id:4,name:"Assassin",icon:"img/assassin.jpg"},{id:5,name:"Ranger",icon:"img/ranger.jpg"},{},{id:7,name:"Sorcerer",icon:"img/sorc.jpg"},{id:8,name:"Spiritmaster",icon:"img/sm.jpg"},{},{id:10,name:"Cleric",icon:"img/cleric.jpg"},{id:11,name:"Chanter",icon:"img/chanter.jpg"},{},{id:13,name:"Aethertech",icon:"img/gladiator.jpg"},{id:14,name:"Gunner",icon:"img/gunner.png"},{},{id:16,name:"Bard",icon:"img/barde.png"}],i.getCharacterRank=function(a){return i.characterSoldierRankIds[a]},i.getCharacterClass=function(a){return i.characterClassIds[a]},i.getFromServer=function(a,b){var f=g.first(function(c){return c.serverName==b&&c.date==a});return f?c.resolve(f):c.likeNormal(e({url:d+"data/Servers/"+a+"/"+b+".json",method:"GET"})).then(function(c){var d={serverName:b,date:a,data:c};return g.push(d),d})},i.getLastFromServer=function(a){return i.getFromServer(b(),a)},i.getCharacterInfo=function(a,b){var f=h.first(function(c){return c.serverName==a&&c.characterID==b});return f?c.resolve(f):c.likeNormal(e({url:d+"data/Servers/Characters/"+a+"/"+b+".json",method:"GET"})).then(function(c){var d={serverName:a,characterID:b,data:c};return h.push(d),d})},i.getLastServerData=function(){return b()}}var c=!1,d=c?"":"http://91.184.11.238/";a.module("mainApp").service("storedDataService",["$hs",b])}(angular),function(a){"use strict";function b(a){var b=this,c=a.get("$q"),e=a.get("$timeout"),f=null,g={};b.$setParent=function(a){return f=a,b},b.$q=c,b.$q.likeHttp=function(a){if(a.promise)return a.promise.success=function(b){return a.promise.then(b),a.promise},a.promise.error=function(b){return a.promise["catch"](b),a.promise},a;if(a.then){var d=b.likeHttp(c.defer());return a.then(d.resolve),a["catch"](d["catch"]),d.promise}},b.$q.likeNormal=function(a){var b=c.defer();return a.success(b.resolve).error(b.reject),b.promise},b.$q.timeTrigger=function(a,b,c){return c||(c=d),g[a]&&e.cancel(g[a]),g[a]=e(b,c),g[a]}}var c="helperService.$q",d=1e3;a.module("mainApp").service(c,["$injector",b])}(angular),function(a){"use strict";a.module("mainApp").directive("fbCommentPlugin",["$window",function(a){function b(a,b,c){return'<div class="fb-comments" data-href="'+a+'" data-numposts="'+b+'" data-colorsheme="'+c+'"></div>'}return{restrict:"A",scope:{},link:function(c,d,e){e.$observe("pageHref",function(c){var f=c,g=e.numposts||5,h=e.colorscheme||"light";d.html(b(f,g,h)),a.FB&&a.FB.XFBML.parse(d[0])})}}}])}(angular);