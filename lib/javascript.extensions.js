...
//Fn that will remove an element and return same array
...
//Fn that will remove an element
Array.prototype.remove = function(element) {
  var _idx = this.indexOf(element);

  if(_idx >= 0) {
    return this.removeAt(_idx);
  }
  return this;
};

//Fn that will remove elements where has a condition
Array.prototype.removeWhere = function(fn) {
  var $$this = this;
  this.where(fn).forEach(function($$element) {
    $$this.remove($$element);
  });
};